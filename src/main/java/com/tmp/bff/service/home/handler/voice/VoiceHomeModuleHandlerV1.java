package com.tmp.bff.service.home.handler.voice;
...
@Slf4j
@Component
@ModuleHandlerVersion(type = 7, minVersion = "2.8.0")
public class VoiceHomeModuleHandlerV1 extends AbstractHomeModuleHandler {
